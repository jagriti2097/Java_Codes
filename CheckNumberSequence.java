...
Then it's strictly increasing (5 8). But then it starts strictly decreasing again (8 2).
...
public class CheckNumberSequence {
    ...
    public static void checkNumberSequence(int[] arr){
        int i=0;
        boolean isDec = true;
        ...
        while(i<arr.length-1)
        {
            ...
            if (current == prev){
                ...
                isDec = false; // now the seq is not decreasing.
            }
            i++;
        }
