...
It sequentially checks each element of the array/list until a match
is found or the whole array/list has been searched.
...
public class LinearSearch {
    ...
    public static void main(String[] args) {
        ...
        int x = s.nextInt();
        System.out.println("Index = " + linearSearch(arr,x));
    }
}
