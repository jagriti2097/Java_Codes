...
we get Rs. 8761.53 and now rounding it off will result in Rs. 8762 and hence the Answer.
...
public class TotalSalary {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the Basic Salary and Grade : ");
        ...
        int total_Sal = (int) Math.round(basic_Sal + hra + da + allow - pf);
